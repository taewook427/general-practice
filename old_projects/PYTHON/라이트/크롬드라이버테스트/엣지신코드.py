...
driver.find_element(By.NAME, 'name').send_keys(u'킹갓엠페러')#닉네임
...
driver.find_element(By.NAME, 'subject').send_keys(u'ㅎㅇ 여러분들'+testnum)#제목
driver.implicitly_wait(1)
time.sleep(1)
...
driver.find_element(By.TAG_NAME, 'body').send_keys(u"ㅎㅇㅎㅇ"+testnum)
time.sleep(1)
