...
def drawdata(name,color,amount,datax,datay,k):
    ...
    t.write(name)
    t.penup()
    t.goto(24*datax[0]-300,4000*(datay[0]-1)-300)
    for i in range(0,amount):
        t.pensize(2)
        t.pendown()
        t.goto(24*datax[i]-300,4000*(datay[i]-1)-300)
        t.pensize(4)
        t.penup()
        t.goto(24*datax[i]-300-3,4000*(datay[i]-1)-300)
        t.pendown()#d
        t.goto(24*datax[i]-300+3,4000*(datay[i]-1)-300)
        t.penup()
        t.goto(24*datax[i]-300,4000*(datay[i]-1)-300-6)
        t.pendown()#d
        t.goto(24*datax[i]-300+2,4000*(datay[i]-1)-300+6)
        t.pensize(2)
        t.penup()
        t.goto(24*datax[i]-300,4000*(datay[i]-1)-300)
print('그래프')
